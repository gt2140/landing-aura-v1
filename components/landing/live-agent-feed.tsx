...
export function LiveAgentFeed() {
  ...
  return (
    <div className="overflow-hidden rounded-[18px] border border-black/[0.08] bg-white/70 shadow-[0_10px_40px_rgba(0,0,0,0.04)] backdrop-blur-md lg:min-h-[456px]">
      ...
      <div className="overflow-hidden">
        {rows.map((row, index) => (
          <div
            key={row.key}
            className="grid min-h-[64px] grid-cols-[92px_minmax(0,1fr)_72px_68px] items-center gap-2 border-b border-black/[0.04] px-4 py-3.5 last:border-b-0 md:grid-cols-[104px_minmax(0,1fr)_88px_80px] md:px-6"
            style={{
...
export function LiveAgentCounter() {
  ...
  return (
    <span className="text-[clamp(2rem,3.4vw,3.15rem)] font-light leading-none tracking-tight text-black/85">
